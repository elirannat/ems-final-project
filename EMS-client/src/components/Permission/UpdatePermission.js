...
const UpdatePermission = () => {
  ...
  const getPermissionList = async () => {
    ...
    fetch(`http://localhost:3000/dev/editpermissionid/${params.id}`, requestOptions)
  ...
  function UpdatePermission() {
    ...
    fetch("http://localhost:3000/dev/edit_permission", requestOptions)
      .then(response => response.json())
      .then(result => {
        console.log(result)
        setData(result)
  ...
  return (
    <>
      ...
      <div className="content-wrapper">
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1>{languageData.updatepermission}</h1>
              </div>
              <div className="col-sm-6">
                  ...
                  <form>
                    <div className="card-body">
                      <div className="form-group">
                        <label htmlFor="exampleInputEmail1">{languageData.permissionname}</label>
        ...
        {/* /.content-wrapper */}
        <div className="btnss">
          <button type="button" class="btn btn-primary submitbtn" onClick={UpdatePermission} ><b>{languageData.submit}</b></button>
