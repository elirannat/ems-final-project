...
const Permission = () => {
  ...
  function getPermissionTotalLength(page) {
    ...
    fetch("http://localhost:3000/dev/permission_list", requestOptions)
  ...
  function handlePreviousPage() {
    if (currentPage > 1) {
      ...
      getPermissionList(currentPage - 1);
    }
  }
  ...
  function deleteRole(id) {
    ...
    fetch("http://localhost:3000/dev/delete_permission", requestOptions)
      .then(response => response.json())
      .then(result => {
        console.log(result)
        getPermissionList()
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1>{languageData.permission}</h1>
              </div>
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  <Link to='/addpermission'>  <button className='add bg-primary'>{languageData.addpermission}</button></Link>
                </ol>
              </div>
            </div>
                    ...
                    <table id="example2" className="table table-head-fixed table-bordered table-hover">
                      <thead>
                        <tr>
                          ...
                          <th className="tableheader">{languageData.permissionname}</th>
                                  ...
                                  return (
                                    <tr key={i}>
                                      ...
                                      <td className="tabledata">
                                        <Link to={'/updatepermission/' + item._id}>
