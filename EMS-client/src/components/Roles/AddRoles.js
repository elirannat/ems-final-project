...
const AddRoles = () => {
  ...
  function addMyRole(e) {
    ...
    fetch("http://localhost:3000/dev/add_role", requestOptions)
  ...
  return (
    <>
      ...
      <div className="content-wrapper">
        ...
        {/* /.content-wrapper */}
        <div className="btnss">
          <button type="button" class="btn btn-primary submitbtn" onClick={addMyRole}><b>{languageData.submit}</b></button>
