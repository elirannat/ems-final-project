...
const UpdateAppraisal = () => {
  ...
  const getAppraisalList = async () => {
    ...
    fetch(`http://localhost:3000/dev/editappraisalid/${params.id}`, requestOptions)
      ...
      .then(result => {
        ...
        setFrom(result.dayFrom)
        setTo(result.dayTo)
        setPrevious(result.previousSalary)
        setNewSalary(result.newSalary)
      })
      .catch(error => console.log('error', error));
  }
  function updateAppraisal(e) {
    ...
    var raw = JSON.stringify({
      ...
      "firstName": firstName,
      "lastName": lastName,
      "userId": "645b7ad1242c834264e3840f",
      "companyId": companyId,
      "dayFrom": from,
      "dayTo": to,
    ...
    fetch("http://localhost:3000/dev/edit_appraisal", requestOptions)
      .then(response => response.json())
      .then(result => {
        console.log(result)
  ...
  return (
    <>
      ...
      <div className="content-wrapper">
        ...
        {/* /.content-wrapper */}
        <div className="btnss">
          <button type="button" class="btn btn-primary submitbtn" onClick={updateAppraisal}><b>{languageData.submit}</b></button>
