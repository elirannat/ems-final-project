...
const AddBankAccount = () => {
  ...
  function store(e) {
    console.log( accountHolderName, bankName, accountNumber, bankBranch, ifsc)
    ...
    fetch("http://localhost:3000/dev/add_bank_account", requestOptions)
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1>{languageData.addbankaccount}</h1>
              </div>
              <div className="col-sm-6">
