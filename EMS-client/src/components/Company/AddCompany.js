...
const AddCompany = () => {
  const handleUpload = () => {
    ...
    myHeaders.append("Authorization", "Bearer 5c9ba1db3e36fbb2acd1846f7c296e813575bce9");
  ...
  function store(e) {
    console.log(companyName, email, mobile, status, website, other, address01, selectedValue,
      address02, landmark, pin, gstno, othertax01, othertax02,
      selectedCountry, selectedState, selectedCity)
    e.preventDefault()

    var myHeaders = new Headers();
    myHeaders.append("Content-Type", "application/json");
    myHeaders.append("Authorization", "Bearer e36a2d8748dd71ea5d5200bdce5b0a55c43168d0");
    ...
    // var myHeaders = new Headers();
    // myHeaders.append("Authorization", "Bearer b2dc1233c8f69df559b446de085b31d860cb18f8");
    // myHeaders.append("Content-Type", "application/json");
...
fetch("http://localhost:3000/dev/edit_company", requestOptions)
