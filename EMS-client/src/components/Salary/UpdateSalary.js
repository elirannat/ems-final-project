...
const UpdateSalary = () => {
  ...
  const getSalaryList = async () => {
    ...
    fetch(`http://localhost:3000/dev/editcompanysalaryid/${params.id}`, requestOptions)
      .then(response => response.json())
      .then(result => {
        console.log(result)
        setSalaryType(result.salaryType)
        setAmount(result.amount)
        setPayAs(result.payAs)
  ...
  function UpdateMySalary() {
    ...
    fetch("http://localhost:3000/dev/edit_company_salary", requestOptions)
      .then(response => response.json())
      .then(result => {
        console.log(result)
        setData(result)
  ...
  return (
    <>
      ...
      <div className="content-wrapper">
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1>{languageData.updatesalary}</h1>
              </div>
              <div className="col-sm-6">
        ...
        {/* /.content-wrapper */}
        <div className="btnss">
          <button type="button" class="btn btn-primary submitbtn" onClick={UpdateMySalary} ><b>{languageData.submit}</b></button>
